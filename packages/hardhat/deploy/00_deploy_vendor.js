...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  await deploy("Vendor", {
    from: deployer,
    args: [myToken.address], // Learn more about args here: https://www.npmjs.com/package/hardhat-deploy#deploymentsdeploy
    log: true,
  });
  ...
  const transferTransaction = await myToken.transfer(
    vendor.address,
  ...
  if (chainId !== "31337") {
    try {
      ...
      await run("verify:verify", {
        ...
        contractArguments: [myToken.address],
      });
    } catch (e) {
